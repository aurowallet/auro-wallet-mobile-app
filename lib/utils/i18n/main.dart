...
const Map<String, String> enMain = {
  ...
  "resetWarnContent":
      "After reseting you existing wallet all the data will be lost. You can only use the mnemonic phrase to restore. Please ensure you have backed-up the mnemonic phrase before you reset the wallet.",
