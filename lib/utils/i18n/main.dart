const Map<String, String> zhMain = {
  ...
  "watchModeWarn": "为了提供更加良好的Dapp体验，Auro 钱包在之后的版本中将不提供【观察钱包】功能，请前往对账户管理页面将已添加的【观察钱包】删除。",
...
const Map<String, String> enMain = {
  ...
  "feePlaceHolder": "Please enter the miner fee ",
  ...
  "isee": "OK",
  "walletHomeTip": "Based on the features of Mina network, activating an account needs to consume 1 MINA for purchasing block storage space, and this fee will be deducted at the first transfer, not charged by the wallet.",
  ...
  'feeTooLarge': 'Miner fee too high, are you sure?',
  'add': 'Add',
