  ...
  Widget _buildSuffixIcon() {
    return IconButton(
      icon: Icon(!_passwordVisibility ? Icons.visibility : Icons.visibility_off,
          color: ColorsUtil.hexColor(0xB0B3BF)),
      onPressed: () {
        setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    OutlineInputBorder border = OutlineInputBorder(
      ...
      borderSide: BorderSide(
          ...
          color:
              widget.isError == true ? Color(0xFFD65A5A) : widget.borderColor),
    );
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: widget.label != null || widget.rightWidget != null
                ? widget.inputPadding
                : EdgeInsets.all(0),
            child: TextField(
              maxLength: widget.maxLength != null
                  ? max(widget.maxLength! - specialCharsCount, 0)
                  : null,
              ...
              decoration: InputDecoration(
                ...
                focusedErrorBorder: border.copyWith(
                    borderSide:
                        BorderSide(color: Color(0xFFD65A5A), width: 0.5)),
