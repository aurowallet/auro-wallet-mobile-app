...
class AppLocalizationsTr extends AppLocalizations {
  ...
  String get ledgerTip2 =>
      '<bold>Mina hazır</bold> mesajını görene kadar Ledger cihazınızda Mina uygulamasını açın.';
  ...
  @override
  String get waitingLedger => 'Onay bekliyor…';
  ...
  String importSameAccount_2(String accountName) {
    return 'Mevcut bir içe aktarılmış hesap [$accountName] bu adresin kopyasıdır. Auro Wallet, yinelenen hesap adreslerinin oluşturulmasını desteklemez. İçe aktarılan hesabı silmek için lütfen <acmanage>Hesap Yönetimi</acmanage>’ne gidin.';
  }
